...
@section('content')
        ...
        <div class="w-full px-2">
                        ...
                        <div class="item">
                            <div class="in">
                                <div class="flex items-center gap-2.5 w-full">
                                    <ion-icon name="timer-outline" class="text-yellow-500 text-[22px]"></ion-icon>
                                    <div class="flex-1 min-w-0">
                                        ...
                                        <br>
                                        <small>
                                            <a href="/presensi/showfilelembur/{{ $d->file_form }}" target="_blank" class="text-blue-600 no-underline">
                                                Form Lembur
                                            </a>
                                        </small>
                                        <br>
                                        <small>
                                            <a href="/presensi/showfilelembur/{{ $d->file_laporan }}" target="_blank" class="text-blue-600 no-underline">
                                                Laporan Lembur
                                            </a>
                                        </small>
                                    </div>
                                ...
                                <div class="flex flex-col gap-1 items-end">
                                    <form action="/presensi/deletelembur/{{ $d->id }}" method="POST" class="form-delete">
                                        @csrf
                                        @method('DELETE')
            ...
            @empty
                <div class="mt-[120px] text-center text-gray-400">
                    ...
                    <h4 class="mt-2 text-coklat">Belum Ada Data Lembur</h4>
                    <small>Data lembur akan muncul di sini</small>
                </div>
            @endforelse
        </div>
    </div>
    ...
    <div class="fab-button bottom-right" style="bottom: 80px; right: 35px;">
        ...
        <a href="/presensi/buatlembur" class="fab bg-coklat text-white">
