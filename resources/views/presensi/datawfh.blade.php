                    ...
                    <div class="card shadow-sm">
                        ...
                        <div class="card-body">
                                ...
                                <tbody>
                                    ...
                                    @forelse ($datawfh as $d)
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                {{ ($datawfh->currentPage() - 1) * $datawfh->perPage() + $loop->iteration }}
                                            </td>
                                            ...
                                            <td>
                                                ...
                                                <a href="/presensi/showfilewfh/{{ $d->file_form }}"
                                                    target="_blank"
                                            ...
                                            <td>
                                                ...
                                                <a href="/presensi/showfilewfh/{{ $d->file_laporan }}"
                                                    target="_blank"
                                            ...
                                            <td>
                                                ...
                                                <form action="/presensi/datawfh/{{ $d->id }}/delete"
                                                    method="POST"
                                                    class="d-inline">
                            ...
                            <div class="mt-3">
                                ...
                                {{ $datawfh->appends(request()->all())->links('vendor.pagination.bootstrap-5') }}
